...
// The starter catalogue shown before membership_plans is seeded. It mirrors
// prisma/seed-plans.ts (the concierge perks, discountPercent 0): editing one
// of these creates it for real, so it must not revive the old partner-discount
// and free-vet-consult promises that were withdrawn.
export const defaultParentSubPlans = [
  ...
  },
  {
    ...
    perks: ['Everything in Bronze Monthly', '₹198 saved vs paying monthly'],
    discountPercent: 0,
    priceRupees: 990,
    durationDays: 365,
    active: true,
  ...
  },
  {
    ...
    name: 'Silver · Annual',
    tagline: '2 months free vs monthly',
    perks: ['Everything in Silver Monthly', '₹498 saved vs paying monthly'],
    discountPercent: 0,
    priceRupees: 2490,
    durationDays: 365,
    recommended: true,
  ...
  },
  {
    ...
    name: 'Gold · Annual',
    tagline: '2 months free vs monthly',
    perks: ['Everything in Gold Monthly', '₹998 saved vs paying monthly'],
    discountPercent: 0,
    priceRupees: 4990,
    durationDays: 365,
    recommended: true,
...
export const defaultVendorSubPlans = [
  {
    ...
    tagline: 'Directory Listing & Enquiries via Pets24x7',
